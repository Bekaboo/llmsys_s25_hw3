...
from project.run_sentiment_linear import Linear, Network
...
def test_Linear_1() -> None:
    ...
    ans = [
        [0.284114, -0.076160, 0.060211, -0.054526, 0.170600],
...
def test_Network_1() -> None:
    ...
    x = [
        [[random.random() for k in range(embed_dim)] for j in range(15)]
